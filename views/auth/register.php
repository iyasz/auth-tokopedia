<div class="container ">
    <div class="row mt-4">
        <div class="col-lg-6 d-lg-block d-md-block d-none mt-5">
            <div class="text-center ff-open ">
                <img src="assets/img/register_new.png" width="370px" alt="">
                <h4 class="mt-4 mb-3 fw-bold fs">Jual Beli Hudah Hanya di Tokopedia</h4>
                ...
                <div class="card-body mx-4">
                    <form action="" method="post">
                        ...
                        <div class="">
                            ...
                            <button id="btn_auth" disabled="disabled" type="submit" class="btn btn-primary w-100 letter-login2 fw-bold btn-login py-2 rounded-3">Daftar</button>
